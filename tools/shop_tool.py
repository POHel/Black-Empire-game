...
4) заработок за 1 клик +100$ / стоимость: 10.000$
A) заработок за 1 клик +1000$ / стоимость: 15.000$
B) заработок за 1 клик +10.000$ / стоимость: 50.000$
C) заработок за 1 клик +50.000$ / стоимость: 100.000${RES}
{RED}---energy---
